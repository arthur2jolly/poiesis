...
@section('tabs')
    ...
    <a href="{{ route('dashboard.stories', $project->code) }}" class="border-b-2 border-blue-500 text-blue-600 px-1 py-3 text-sm font-medium">Stories</a>
...
@section('content')
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        ...
        @php
            $blockedBy = $story->blockedBy ?? collect();
            $blocks = $story->blocks ?? collect();
        @endphp
